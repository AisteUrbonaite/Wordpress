...
if ( ! function_exists( 'bootstrap_four_theme_styles' ) ) :
  function bootstrap_four_theme_styles() {
    ...
    wp_register_style( 'my-custom-style', get_template_directory_uri() . '/css/style.css', array());
    ...
    wp_enqueue_style( 'my-custom-style', get_template_directory_uri() . '/css/style.css', array( '' ), '1' );
    wp_enqueue_style( 'bootstrap-theme', get_template_directory_uri() . '/css/bootstrap-theme.css', array( '' ), '1' );
  }
endif;
